...
ADD https://github.com/nagios-plugins/nagios-plugins/releases/download/${NAGIOS_PLUGINS_VERSION}/nagios-plugins-${NAGIOS_PLUGINS_VERSION}.tar.gz /tmp
